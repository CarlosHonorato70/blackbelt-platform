import { boolean, timestamp, index, integer, jsonb, pgTable, text, unique, varchar, } from "drizzle-orm/pg-core";
/**
...
// ============================================================================
export const assessmentProposals = pgTable("assessment_proposals", {
    id: varchar("id", { length: 64 }).primaryKey(),
    tenantId: varchar("tenantId", { length: 64 }).notNull(),
