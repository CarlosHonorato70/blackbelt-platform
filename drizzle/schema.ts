...
export const users = mysqlTable("users", {
  ...
  professionalRegistry: varchar("professionalRegistry", { length: 100 }),
  professionalRole: varchar("professionalRole", { length: 255 }),
...
export const tenants = mysqlTable(
  "tenants",
  {
    ...
    strategy: varchar("strategy", { length: 50 }).default("shared_rls").notNull(),
...
export const people = mysqlTable(
  "people",
  {
    ...
    employmentType: varchar("employmentType", { length: 50 }).default("own").notNull(),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().notNull(),
  },
  (table) => ({
...
export const services = mysqlTable(
  "services",
  {
    ...
    unit: varchar("unit", { length: 50 }).default("hour").notNull(),
...
export const pricingParameters = mysqlTable(
  "pricing_parameters",
  {
    ...
    defaultTaxRegime: varchar("defaultTaxRegime", { length: 50 }).default("SN").notNull(),
...
export const subscriptions = mysqlTable(
  "subscriptions",
  {
    ...
    status: varchar("status", { length: 30 }).default("trialing").notNull(),
    billingCycle: varchar("billingCycle", { length: 50 }).default("monthly").notNull(),
...
export const featureFlags = mysqlTable(
  "feature_flags",
  {
    ...
    displayName: varchar("displayName", { length: 100 }).notNull(),
    description: text("description"),
    category: varchar("category", { length: 100 }).default("core").notNull(),
    isActive: boolean("isActive").default(true).notNull(),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().notNull(),
  },
