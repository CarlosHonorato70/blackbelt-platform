...
const ADMIN_SERVICES = [
  ...
  { category: "inventario",     name: "Inventário de Riscos Psicossociais",        description: "Mapeamento e classificação de riscos conforme Guia MTE 2024. Matriz severidade x probabilidade, identificação de fatores críticos e priorização.",          unit: "project", minPrice: 80000,  maxPrice: 150000 },
  ...
  { category: "treinamento",    name: "Treinamento NR-01 (por colaborador, 8h)",  description: "Programa de capacitação em riscos psicossociais: identificação, prevenção, canal de denúncia e liderança saudável. Presencial ou EAD com certificado.",              unit: "person",  minPrice: 10000,  maxPrice: 15000  },
  { category: "pgr_pcmso",      name: "Integração PGR/PCMSO",                     description: "Elaboração do PGR psicossocial integrado ao PCMSO (NR-07). Inclui recomendações de exames, frequência e população-alvo baseados nos riscos identificados.",         unit: "project", minPrice: 200000, maxPrice: 350000 },
